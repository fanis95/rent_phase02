...
public class reservation {
    ...
    protected static final AtomicInteger count = new AtomicInteger(1000);
    ...
    double charge()
    {
        ...
        else // an h krathsh einai gia mia mera dhladh
        {
            xrewsh = r.charge_per_day();
        }
